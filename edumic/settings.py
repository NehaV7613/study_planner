"""
Django settings for edumic project.
...
SECRET_KEY = 'django-insecure-wp+lt@u&+6g(*l&p)$-8nmr2xpr0_z749yt_#4qg6+@#o^@)!d'
...
WSGI_APPLICATION = 'edumic.wsgi.application'
